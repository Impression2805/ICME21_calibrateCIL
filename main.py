...
from calibrateCIL import calibrateCIL
from ResNet import resnet18_cbam
from myNetwork import network
from iCIFAR100 import iCIFAR100

parser = argparse.ArgumentParser(description='Calibration for Non-exemplar based Class-incremental Learning')
...
def main():
    ...
    model = calibrateCIL(args, file_name, feature_extractor, task_size, device)
